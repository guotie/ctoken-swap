...
contract LeverageHoldingUnitroller is LeverageHoldingUnitrollerStorage , LeverageError {
    ...
    /*** Admin Functions ***/
    function _setImplementation(address newPendingImplementation) public returns (uint) {
        ...
        comptrollerImplementation = newPendingImplementation;
