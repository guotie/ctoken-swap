...
// File contracts/swap/heco/PairStorage.sol
...
// File contracts/swap/heco/Pair.sol
...
contract DeBankPair is IDeBankPair, PairStorage {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        {// scope for reserve{0,1}Adjusted, avoids stack too deep errors
            ...
            require(balance0Adjusted.mul(balance1Adjusted) >= uint(_reserve0).mul(_reserve1).mul(10000 ** 2), 'DeBankSwap: K');
        }
...
// File contracts/swap/heco/Factory.sol
